...
<body class="bg-ink-50 font-sans text-ink-900 antialiased">
    ...
    <div class="product_comments_block space-y-4 p-4">
        ...
        <div class="comment-btn-area mt-3">
            <?php if ($canReview) { ?>
                <form action="<?= e($_SERVER['PHP_SELF']) ?>" method="post" data-validate novalidate class="rounded-2xl border border-ink-200 bg-ink-800/70 backdrop-blur-xl p-4 shadow-sm">
