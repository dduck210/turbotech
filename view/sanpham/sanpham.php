...
<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 md:py-16">
    <div class="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-8">
        ...
        <aside class="order-2 lg:order-1 space-y-6">
            ...
            <!-- Categories -->
            <div class="rounded-2xl border border-ink-200 bg-ink-200/70 backdrop-blur-xl p-5">
                ...
                <ul class="space-y-1">
                    <?php foreach ($listcate as $cate) {
                        ...
                        $cateLinkClass = $isActiveCate
                            ? 'flex items-center gap-2 rounded-lg bg-brand-500/10 px-3 py-2 text-sm font-semibold text-brand-700'
                            ...
                            <div class="min-w-0">
                                ...
                                <div class="mt-1">
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <span class="text-ink-600 line-through text-xs ml-1"><?= number_format($topsp['price']) ?>₫</span>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
        ...
        <div class="order-1 lg:order-2">
            ...
            <form action="index.php" method="get" class="rounded-2xl border border-ink-200 bg-ink-200/70 backdrop-blur-xl p-5 mb-8">
            ...
            <?php if (empty($listpro)) { ?>
                <div class="rounded-2xl border border-ink-200 bg-ink-200/70 backdrop-blur-xl py-16 text-center mb-8">
                    <i class="fa-solid fa-face-sad-tear text-5xl text-ink-600" aria-hidden="true"></i>
                    ...
                    <div class="rounded-2xl border border-ink-200 bg-ink-200/70 backdrop-blur-xl shadow-sm hover:shadow-md transition-shadow overflow-hidden">
                        <div class="relative aspect-square bg-ink-100 overflow-hidden">
                            ...
                            <?php if ((int) $pro['stock'] <= 0) { ?>
                                <span class="absolute top-2 right-2 rounded-full bg-ink-100/80 text-white text-xs font-bold px-2 py-1">
                        ...
                        <div class="p-4">
                            ...
                            <div class="mb-3">
                                ...
                                <?php } else { ?>
                                    ...
                                    <span class="text-ink-600 line-through text-sm ml-1">
                                        <?= number_format($pro['price']) ?>₫
                                    </span>
                                <?php } ?>
                            </div>
