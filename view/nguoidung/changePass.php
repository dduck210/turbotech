        ...
        <div class="mx-auto max-w-md rounded-2xl border border-ink-200 bg-white shadow-sm p-6 sm:p-8">
            <form action="index.php?act=changePass" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="password" id="changepass-newpass" name="newpass" placeholder="Nhập mật khẩu mới" required
                ...
                <div class="mb-6">
                    ...
                    <?php if (isset($error['fail'])) : ?>
                        <p class="mt-1.5 text-sm text-red-600"><?php echo $error['fail']; ?></p>
                    <?php endif; ?>
                </div>
