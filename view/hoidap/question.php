    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex justify-center">
            <div class="w-full lg:w-1/2">
                <!-- form hỏi đáp-->
                <form action="index.php?act=question" method="post" data-validate novalidate class="rounded-2xl border border-ink-200 bg-ink-200/70 backdrop-blur-xl p-6 shadow-sm sm:p-8">
