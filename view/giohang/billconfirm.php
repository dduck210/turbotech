 ...
 <article class="mt-3 container-sm">
     <h5 class="alert alert-primary">Đặt hàng thành công! Cảm ơn quý khách đã mua hàng của Turbotech</h5>
     <?php
         ...
         <div class="card">
             ...
             <div class="card-body">
                 <div class="wrap-infocart mar-t5">
                     ...
                     <input name="" type="text" class="ip-cart ml-60 fw-bold" value="<?= $user_name ?>" disabled />
                 </div>
                 <div class="wrap-infocart mar-t5">
