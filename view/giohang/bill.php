 ...
 <article class="mt-3 container-sm">
     ...
     <form action="index.php?act=billconfirm" method="post">
         ...
         <div class="card">
             ...
             <div class="card-body">
                 <div class="wrap-infocart mar-t5">
                     ...
                     <input name="user_name" type="text" class="ip-cart ml-60 font-weight-bolder"
         ...
         <div class="mt-3 mb-3">
             <nav class="navbar">
                 <p class="m-0 p-0 text-danger fw-bold navbar-brand">Bạn chưa đăng nhập. Hãy đăng nhập tài khoản để tiến
                     hành đặt hàng!</p>
                 <a href="index.php?act=login" class="btn btn-secondary my-2 my-sm-0"><i
