...
<div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 md:py-16">
    <div class="flex justify-center">
        <div class="w-full lg:w-3/4">
            <!-- form liên hệ-->
            <form action="index.php?act=contact" method="post" data-validate novalidate class="rounded-2xl border border-ink-200 bg-ink-200/70 backdrop-blur-xl p-6 shadow-sm sm:p-8">
