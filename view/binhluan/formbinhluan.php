...
<?php
    ...
    <div class="product_comments_block space-y-4 p-4">
        ...
        <?php if ($canReview) { ?>
            <form action="<?= $_SERVER['PHP_SELF']; ?>" method="post" data-validate novalidate class="rounded-2xl border border-ink-200 bg-ink-200/70 backdrop-blur-xl p-4 shadow-sm">
