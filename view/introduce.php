    ...
    <div class="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8 md:py-16">
        ...
        <div class="mt-8 rounded-2xl border border-ink-200 bg-ink-800/70 backdrop-blur-xl p-6 shadow-sm sm:p-8">
            ...
            <p class="mt-3 pl-4 text-base leading-relaxed text-ink-700">
                ...
                Khách Hàng”, nhằm mang đến những trải nghiệm mua sắm và hậu mãi hoàn hảo, trọn vẹn nhất. <br>
            </p>
        </div>
        ...
        <div class="mt-8 rounded-2xl border border-ink-200 bg-ink-800/70 backdrop-blur-xl p-6 shadow-sm sm:p-8">
            ...
            <p class="mt-3 pl-4 text-base leading-relaxed text-ink-700">
                ...
                PC/Laptop mình đang quan tâm bao gồm: giá cả, thông số cấu hình chi tiết (CPU, RAM, VGA, Ổ cứng), chế độ
                bảo hành, tình trạng máy (mới 100% hay hàng lướt)... cũng như dễ dàng so sánh các cấu hình với nhau.<br>
                - Minh bạch về chi phí: Giúp người dùng nắm rõ thông tin về giá máy, chi phí nâng cấp linh kiện hoặc các
                dịch vụ cài đặt, vệ sinh máy máy tính muốn thực hiện mà không lo phát sinh chi phí ẩn.<br>
                - Mua sắm tiện lợi, tiết kiệm thời gian: Website tích hợp hệ thống đặt hàng thông minh, giúp khách hàng
                sở
