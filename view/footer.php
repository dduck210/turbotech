<footer class="bg-ink-100 text-ink-700">
        ...
        <div class="grid grid-cols-1 gap-10 md:grid-cols-3">
            ...
            <div>
                ...
                <nav class="mt-4 flex flex-wrap gap-x-4 gap-y-2 text-sm">
                    <a href="index.php" class="text-ink-600 transition-colors hover:text-white focus:outline-none focus:ring-2 focus:ring-brand-500">Trang chủ</a>
                    <a href="index.php?act=product" class="text-ink-600 transition-colors hover:text-white focus:outline-none focus:ring-2 focus:ring-brand-500">Sản phẩm</a>
                    <a href="index.php?act=introduce" class="text-ink-600 transition-colors hover:text-white focus:outline-none focus:ring-2 focus:ring-brand-500">Giới thiệu</a>
                    <a href="index.php?act=contact" class="text-ink-600 transition-colors hover:text-white focus:outline-none focus:ring-2 focus:ring-brand-500">Liên hệ</a>
                    <a href="index.php?act=question" class="text-ink-600 transition-colors hover:text-white focus:outline-none focus:ring-2 focus:ring-brand-500">Hỏi đáp</a>
                </nav>
                <p class="mt-6 text-sm text-ink-600">Tubotech &copy; 2026</p>
            </div>
    ...
    <div class="flex h-full w-full items-center justify-center">
        <div class="w-full max-w-sm rounded-2xl bg-ink-200/70 backdrop-blur-xl p-6 shadow-xl">
            ...
            <div class="flex justify-end gap-3">
                <button type="button" id="confirm-dialog-cancel" class="rounded-lg border border-ink-200 bg-ink-200/70 backdrop-blur-xl px-4 py-2 text-sm font-semibold text-ink-900 transition-colors hover:bg-ink-50 focus:outline-none focus:ring-2 focus:ring-brand-500">Hủy</button>
