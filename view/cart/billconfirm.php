...
<div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-8 md:py-12">
    <div class="mb-6 flex items-center gap-3 rounded-md border border-green-500/30 bg-green-500/10 p-4 text-sm font-semibold text-green-700">
...
<?= \Codemoi\Core\Csrf::field() ?>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input id="billconfirm-full-name" name="full_name" type="text" value="<?= e($full_name) ?>" readonly
                        class="block w-full rounded-md border border-ink-200 bg-ink-100 px-3.5 py-2.5 text-sm font-semibold text-ink-900" />
                </div>
                <div>
        ...
        <div class="mb-6 card-boutique rounded-md p-6">
            ...
            <label class="flex min-h-11 items-center gap-3 rounded-md border border-ink-300 px-4 py-3">
