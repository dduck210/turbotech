...
<div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-8 md:py-12">
    ...
    <form action="index.php?act=billconfirm" method="post">
        <div class="mb-6 rounded-2xl border border-ink-200 bg-white p-6 shadow-sm">
            ...
            <div class="space-y-4">
                <div>
                    <label for="viewbill-user-name" class="block text-sm font-medium text-ink-700 mb-1.5">Tài khoản người dùng</label>
                    <input id="viewbill-user-name" name="user_name" type="text" value="<?= $user_name ?>" disabled
                ...
                <div>
                    <label for="viewbill-full-name" class="block text-sm font-medium text-ink-700 mb-1.5">Họ tên người đặt</label>
                    <input id="viewbill-full-name" name="full_name" type="text" value="<?= $full_name ?>" readonly
                        class="block w-full rounded-lg border border-ink-200 bg-ink-50 px-3.5 py-2.5 text-sm font-semibold text-ink-900" />
                </div>
                <div>
                    <label for="viewbill-address" class="block text-sm font-medium text-ink-700 mb-1.5">Địa chỉ</label>
                    <input id="viewbill-address" name="address" type="text" value="<?= $address ?>" readonly
                        class="block w-full rounded-lg border border-ink-200 bg-ink-50 px-3.5 py-2.5 text-sm font-semibold text-ink-900" />
                </div>
                <div>
                    <label for="viewbill-email" class="block text-sm font-medium text-ink-700 mb-1.5">Email</label>
                    <input id="viewbill-email" name="email" type="email" value="<?= $email ?>" readonly
                        class="block w-full rounded-lg border border-ink-200 bg-ink-50 px-3.5 py-2.5 text-sm font-semibold text-ink-900" />
                </div>
                <div>
                    <label for="viewbill-phone" class="block text-sm font-medium text-ink-700 mb-1.5">Điện thoại</label>
                    <input id="viewbill-phone" name="phone" type="text" value="0<?= $phone ?>" readonly
                        class="block w-full rounded-lg border border-ink-200 bg-ink-50 px-3.5 py-2.5 text-sm font-semibold text-ink-900" />
                </div>
            </div>
        </div>
