...
--
-- Regenerated 2026-07-12 from the live `codemoi2` database after recovering
-- it from a corrupted MySQL instance. Includes everything needed for a
-- fresh machine to run the app correctly as the laptop store it actually
-- is: schema for all 9 tables (including `coupons` + `bill.coupon_code`/
-- `discount_amount`, previously a separate manual step via create_table.php),
-- the real laptop catalog (names/specs/images matching public/admin/uploads/),
-- and user passwords already bcrypt-hashed (no separate migration needed).
--
...
CREATE DATABASE IF NOT EXISTS codemoi2 CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE codemoi2;
...
INSERT INTO `history_bank` VALUES (21,'1000','CUSTOMER 94173 Trace 985625','30/11/2022 14:30:00','FT22334261631086BNK'),(22,'0','CUSTOMER DO QUANG LINH chuyen khoan - Ma gia o dich/ Trace 401309','30/11/2022 13:40:00','FT22334147891961'),(23,'0','CUSTOMER Thanh toan QR DO QUANG LINH chuyen  khoan - Ma giao dich/ Trace 031916','30/11/2022 11:45:00','FT22334401685537'),(24,'0','CUSTOMER DO QUANG LINH chuyen khoan - Ma gia o dich/ Trace 070167','30/11/2022 11:18:00','FT22334305991988'),(25,'100000','CUSTOMER MBVCB 2768157086 025846 NGUYEN KHAC  TOAN chuyen tien CT tu 04510004281 92 NGUYEN KHAC TOAN toi 60000000003  DO QUANG LINH Ngan hang Quan Doi  ','30/11/2022 10:44:00','FT22334426800035BNK'),(26,'0','CUSTOMER Thanh toan QR DO QUANG LINH chuyen  khoan - Ma giao dich/ Trace 462972','30/11/2022 09:02:00','FT22334100078954'),(27,'1000','CUSTOMER Linh 17654 Trace 588656','30/11/2022 02:33:00','FT22334547643305BNK'),(28,'1000','CUSTOMER Linh 04678 Trace 581325','30/11/2022 02:18:00','FT22334507816023BNK'),(29,'1000','CUSTOMER Chuyen tien Trace 571867','30/11/2022 01:53:00','FT22334062224594BNK');
