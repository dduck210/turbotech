...
<div class="mx-auto max-w-lg">
    <h1 class="mb-6 font-heading text-2xl font-semibold text-ink-900">Liên hệ</h1>
    <form action="{{ route('contact.submit') }}" method="post" class="space-y-4 rounded-md border border-ink-200 bg-white p-6">
        @csrf
        <div>
        ...
        <button type="submit" class="btn-boutique rounded-md px-6 py-2.5 text-sm font-semibold">Gửi liên hệ</button>
    </form>
</div>
@endsection
