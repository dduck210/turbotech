...
<div class="mx-auto max-w-md">
    ...
    <form action="{{ route('register') }}" method="post" class="space-y-4 rounded-md border border-ink-200 bg-white p-6">
        @csrf
        <div>
        ...
        <button type="submit" class="btn-boutique w-full rounded-md px-5 py-2.5 text-sm font-semibold">Đăng ký</button>
        <p class="text-center text-sm text-ink-600">Đã có tài khoản? <a href="{{ route('login.show') }}" class="text-brand-600 underline">Đăng nhập</a></p>
    </form>
</div>
@endsection
