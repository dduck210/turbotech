...
<?= \Codemoi\Core\Csrf::field() ?>
                <div class="mb-4">
                    <label for="formGroupExampleInput" class="block text-sm font-medium text-slate-700 mb-1">Mã hóa
                        đơn</label>
                ...
                <div class="mb-4">
                    <label for="formGroupExampleInput" class="block text-sm font-medium text-slate-700 mb-1">Phương thức
                        thanh toán</label>
                ...
                <div class="mb-4">
                    <label for="formGroupExampleInput" class="block text-sm font-medium text-slate-700 mb-1">Thanh
                        toán</label>
                    <select required
                ...
                <div class="mb-4">
                    <label for="formGroupExampleInput" class="block text-sm font-medium text-slate-700 mb-1">Trạng
                        thái</label>
                    <select required
                        class="w-full rounded-lg border border-slate-200 px-4 py-2 focus:ring-2 focus:ring-brand-500 outline-none transition-all bg-white"
                        name="status" id="">
