...
<?= \Codemoi\Core\Csrf::field() ?>
                ...
                <div class="wrap-btn">
                    <input type="submit" name="btn_add"
                        class="bg-brand-600 hover:bg-brand-700 text-white font-medium rounded-lg px-4 py-2 transition-all active:scale-[0.97] inline-block mt-3"
                        value="Thêm">
                    <a href="index.php?act=list_category"
                        class="bg-red-500 hover:bg-red-600 text-white rounded-lg px-3 py-1.5 mt-3 inline-block">Quay Lại
                        danh sách</a>
                </div>
            </form>
