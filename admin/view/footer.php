                ...
                <!-- Footer -->
                <footer class="bg-ink-800/70 backdrop-blur-xl border-t border-ink-200 py-4 px-6 shrink-0 z-10">
         ...
         classes are seen by Tailwind's content scan. -->
                <div id="confirm-dialog-overlay" class="hidden fixed inset-0 z-50 bg-ink-900/50 p-4">
                    <div class="flex h-full w-full items-center justify-center">
                        <div class="w-full max-w-sm rounded-2xl bg-ink-800/70 backdrop-blur-xl p-6 shadow-xl">
                            ...
                            <div class="flex justify-end gap-3">
                                <button type="button" id="confirm-dialog-cancel"
                                    class="rounded-lg border border-ink-200 bg-ink-800/70 backdrop-blur-xl px-4 py-2 text-sm font-semibold text-ink-900 transition-colors hover:bg-ink-50 focus:outline-none focus:ring-2 focus:ring-brand-500">Hủy</button>
