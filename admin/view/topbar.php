<header class="h-20 bg-white/80 backdrop-blur-md border-b border-slate-200 flex items-center justify-between px-6 shrink-0 z-10 sticky top-0 shadow-sm">
    <div class="flex items-center">
        ...
        <div class="hidden md:flex relative ml-4">
            ...
            <input type="text" placeholder="Tìm kiếm..." class="bg-slate-100 text-sm rounded-full pl-10 pr-4 py-2 border-none focus:ring-2 focus:ring-brand-500 outline-none w-40 lg:w-64 transition-all focus:w-56 lg:focus:w-80">
        </div>
    </div>
