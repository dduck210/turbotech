...
<?= \Codemoi\Core\Csrf::field() ?>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <!-- Mã sản phẩm -->
                <div>
                    <label class="block text-sm font-medium text-ink-700 mb-2">Mã sản phẩm</label>
                    <input type="text" name="id_pro"
                        class="w-full px-4 py-2 border border-ink-200 rounded-lg focus:ring-2 focus:ring-brand-500 focus:border-brand-500 transition-colors"
                        placeholder="Mã loại (auto)">
                </div>

                <!-- Tên sản phẩm -->
                <div>
                    <label class="block text-sm font-medium text-ink-700 mb-2">Tên sản phẩm</label>
                ...
                <!-- Giá -->
                <div>
                    <label class="block text-sm font-medium text-ink-700 mb-2">Giá (₫)</label>
                ...
                <!-- Giảm giá -->
                <div>
                    <label class="block text-sm font-medium text-ink-700 mb-2">Giảm giá (%)</label>
                ...
                <!-- Số lượng tồn kho -->
                <div>
                    <label class="block text-sm font-medium text-ink-700 mb-2">Số lượng tồn kho</label>
                ...
                <!-- Thông báo hết hàng -->
                <div>
                    <label class="block text-sm font-medium text-ink-700 mb-2">Thông báo hết hàng</label>
                ...
                <!-- Mô tả ngắn -->
                <div class="md:col-span-2">
                    <label class="block text-sm font-medium text-ink-700 mb-2">Mô tả ngắn</label>
                ...
                <!-- Mô tả chi tiết -->
                <div class="md:col-span-2">
                    <label class="block text-sm font-medium text-ink-700 mb-2">Mô tả chi tiết</label>
                    <textarea name="detail_des" id="detail_des" rows="5"
                        class="w-full px-4 py-2 border border-ink-200 rounded-lg focus:ring-2 focus:ring-brand-500 focus:border-brand-500 transition-colors ckeditor"
                        placeholder="Mô tả đầy đủ chi tiết sản phẩm"></textarea>
                </div>
            </div>

            <div class="flex items-center gap-4 mt-8 pt-6 border-t border-ink-100">
                ...
                <a href="?act=list_product"
                    class="px-6 py-2.5 bg-ink-100 text-ink-700 font-medium rounded-lg hover:bg-ink-200 focus:ring-4 focus:ring-ink-100 transition-all">Hủy
                    & Quay lại</a>
            </div>
        </form>
