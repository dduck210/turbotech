          ...
          <div class="form-addcate">
            <form action="index.php?act=update_category" method="post" data-validate novalidate>
              ...
              <div class="mb-4">
                ...
                <input type="text" name="name_cate" data-rules="required|min:2|max:100" class="w-full rounded-lg border border-slate-200 px-4 py-2 focus:ring-2 focus:ring-brand-500 outline-none transition-all mb-4" value="<?= $name_cate ?>">
              </div>
