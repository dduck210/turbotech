...
<?= \Codemoi\Core\Csrf::field() ?>
                    ...
                    <div class="w-full lg:flex-1">
                        ...
                        <input type="text" name="keyword"
                            ...
                            class="w-full px-4 py-2 border border-ink-300 rounded-lg focus:ring-2 focus:ring-brand-500 focus:border-brand-500 transition-colors bg-ink-200/70 backdrop-blur-xl">
                    </div>
                    ...
                    <div class="w-full lg:w-auto flex flex-col sm:flex-row gap-3">
                        <div>
                            ...
                            <input type="date" name="from_date"
                                ...
                                class="w-full px-4 py-2 border border-ink-300 rounded-lg focus:ring-2 focus:ring-brand-500 focus:border-brand-500 transition-colors bg-ink-200/70 backdrop-blur-xl text-ink-700">
                        </div>
                        <div>
                    ...
                    <div class="w-full lg:w-auto">
                        <button type="submit" name="btn_filter"
                            class="w-full px-6 py-2.5 bg-ink-200 text-white font-medium rounded-lg hover:bg-ink-100 focus:ring-4 focus:ring-ink-300 transition-all cursor-pointer whitespace-nowrap shadow-sm">
                        ...
                        ?>
                            <tr class="hover:bg-ink-50 transition-colors">
                                ...
                                <td class="px-4 py-4 text-center"><?php if ($bill['status_pay'] == 0) {
                                                                        echo "<span class='inline-flex items-center justify-center px-2.5 py-1 text-xs font-bold rounded-full bg-amber-500/15 text-amber-700'>Chưa thanh toán</span>";
                                                                    } else if ($bill['status_pay'] == 1) {
                                                                        echo "<span class='inline-flex items-center justify-center px-2.5 py-1 text-xs font-bold rounded-full bg-emerald-500/15 text-emerald-700'>Đã thanh toán</span>";
                                                                    } else {
                                                                        echo "Không tìm thấy phương thức thanh toán";
                                                                    }  ?></td>
                                <td class="px-4 py-4 text-center"><?php if ($bill['status'] == 0) {
                                                                        ...
                                                                        echo "<span class='inline-flex items-center justify-center px-2.5 py-1 text-xs font-bold rounded-full bg-amber-500/15 text-amber-700'>Đang xử lý</span>";
                                                                    } else if ($bill['status'] == 2) {
                                                                        echo "<span class='inline-flex items-center justify-center px-2.5 py-1 text-xs font-bold rounded-full bg-brand-500/15 text-brand-700'>Đang giao hàng</span>";
                                                                    } else if ($bill['status'] == 3) {
                                                                        echo "<span class='inline-flex items-center justify-center px-2.5 py-1 text-xs font-bold rounded-full bg-emerald-500/15 text-emerald-700'>Đã giao hàng</span>";
                                                                    } elseif ($bill['status'] == 4) {
                                                                        echo "<span class='inline-flex items-center justify-center px-2.5 py-1 text-xs font-bold rounded-full bg-red-500/15 text-red-600'>Đã hủy</span>";
                                                                    } else {
                                                                        echo "Lỗi trạng thái";
                                                                    } ?></td>
                                    ...
                                    <div class="flex items-center justify-center gap-2">
                                        <?php if ($bill['status'] == 0): ?>
                                            <a href="index.php?act=approve_bill&idbill=<?= e($bill['id_bill']) ?>&_token=<?= urlencode(\Codemoi\Core\Csrf::token()) ?>"
                                                class="p-2 text-blue-600 bg-blue-500/10 rounded-lg hover:bg-blue-500/15 transition-all active:scale-90"
                                        ...
                                        <?php elseif ($bill['status'] == 1): ?>
                                            <a href="index.php?act=ship_bill&idbill=<?= e($bill['id_bill']) ?>&_token=<?= urlencode(\Codemoi\Core\Csrf::token()) ?>"
                                                class="p-2 text-indigo-600 bg-indigo-500/10 rounded-lg hover:bg-indigo-500/15 transition-all active:scale-90"
                                        ...
                                        <a href="index.php?act=billdetail&idbill=<?= e($bill['id_bill']) ?>"
                                            class="p-2 text-emerald-600 bg-emerald-500/10 rounded-lg hover:bg-emerald-500/15 transition-all active:scale-90"
